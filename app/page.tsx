    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-20 text-center px-6 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            Frontend Developer
            
          </h1>

          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            As a dedicated Frontend Developer skilled in React, Tailwind CSS,
            and JavaScript, I specialize in crafting user-friendly and visually
            engaging websites. From responsive layouts to dynamic interactions,
            I aim to build experiences that not only look good but also solve
            real user problems. I’m continuously exploring new tools and
            frameworks to push boundaries — currently diving into technologies
            like Three.js to take web experiences to the next level.
          </p>
            ...
            >
              ...
              >
                <path
                  ...
                  d="M16.862 14.487c-.246-.123-1.453-.718-1.678-.799-.225-.082-.389-.123-.553.123-.164.246-.633.799-.776.963-.143.164-.287.184-.533.062-.246-.123-1.037-.382-1.976-1.218-.73-.652-1.223-1.457-1.367-1.703-.143-.246-.015-.378.108-.5.111-.11.246-.287.369-.43.123-.143.164-.246.246-.41.082-.164.041-.308-.02-.43-.062-.123-.553-1.336-.757-1.832-.2-.48-.404-.415-.553-.423l-.47-.008c-.164 0-.43.062-.656.308-.225.246-.86.84-.86 2.048 0 1.208.88 2.377 1.002 2.541.123.164 1.73 2.645 4.2 3.603.588.202 1.045.322 1.402.412.59.15 1.127.129 1.552.078.474-.056 1.453-.594 1.658-1.168.205-.574.205-1.066.143-1.168-.062-.102-.225-.164-.47-.287z"
                />
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M21 12c0-4.97-4.03-9-9-9s-9 4.03-9 9c0 1.591.417 3.086 1.144 4.382L3 21l4.755-1.244A8.963 8.963 0 0012 21c4.97 0 9-4.03 9-9z"
                />
              </svg>
              Contact on WhatsApp
            </Button>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              From interactive 3D experiences to responsive web applications, I
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-900 p-8 rounded-lg border border-gray-800 hover:border-purple-500 transition-colors">
              ...
              <p className="text-gray-400 mb-6">
                Build engaging and interactive web interfaces with
                scroll-triggered animations, smooth transitions, and modern
                motion libraries.
              </p>
            ...
            <div className="bg-gray-900 p-8 rounded-lg border border-gray-800 hover:border-purple-500 transition-colors">
              ...
              <p className="text-gray-400 mb-6">
                Build scalable, performant web applications using React,
                Next.js, and modern JavaScript frameworks with best practices.
              </p>
              <ul className="text-gray-300 space-y-2">
            ...
            <div className="bg-gray-900 p-8 rounded-lg border border-gray-800 hover:border-purple-500 transition-colors">
              ...
              <p className="text-gray-400 mb-6">
                Transform designs into pixel-perfect, responsive interfaces with
